...
![一个纹理.png](/images/一个纹理.png)

为了把纹理正确的映射到模型上，我们必须要知道纹理映射的坐标，指定三角形每个对应上纹理的哪个部分。

## 纹理坐标系
下面是上图的纹理坐标：
![纹理坐标系.png](/images/纹理坐标系.png)
